...
static void init()
	...
	list.add(new Challenge(Local.BANKER, 1, 		10000000));
	list.add(new Challenge(Local.BILL_GATES, 1,		100000000));
	list.add(new Challenge(Local.WIRT_THE_PEG_LEG, 1,	1000000000));
